...
export const PLANS = [
  ...
  },
  {
    ...
    featuresShort: ["Starter inclus : Avis Google, Commande QR, Portails Serveur/Cuisine/Caisse", "Réservations Intelligentes & anti no-show", "Programme Fidélité inclus"],
    featuresDetailed: [
      { name: "Tout le forfait Starter dont Avis Google & Réputation, Commande & Paiement QR, Portail Serveur, Portail Cuisine et Portail Caisse", desc: "Le Pro reprend explicitement chaque brique du Starter : campagnes d'avis Google avec IA rédactionnelle, menu digital QR, paiement fractionné, suivi serveur, écran cuisine et portail caisse sécurisé." },
  ...
  },
  {
    ...
    features: [
      "Tout le forfait Pro dont Starter complet, Réservations Intelligentes et Programme Fidélité inclus",
    ...
    featuresShort: ["Pro inclus : Starter détaillé + Réservations + Fidélité", "Nova Stock IA", "Nova Finance IA", "Nova Contab IA"],
    featuresDetailed: [
      { name: "Tout le forfait Pro dont Starter complet, Réservations Intelligentes et Programme Fidélité", desc: "Le Business reprend explicitement le Starter (Avis Google, Commande QR, Portails Serveur/Cuisine/Caisse) + les Réservations Intelligentes + le Programme Fidélité clients, points, niveaux VIP, offres et récompenses." },
